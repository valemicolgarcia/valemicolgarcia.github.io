...
Desplegada en Hugging Face Spaces para usar desde el portfolio web
"""
...
app = Flask(__name__)
# Configurar CORS para permitir requests desde cualquier origen (incluyendo GitHub Pages)
